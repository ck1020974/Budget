  ...
  container.innerHTML = `
    <div class="ending-result">
      ...
      <div id="group-feedback" class="feedback-container">
        <div class="feedback-card" id="group-feedback-1">族群評語一</div>
        <div class="feedback-card" id="group-feedback-2">族群評語二</div>
        <div class="feedback-card" id="group-feedback-3">族群評語三</div>
      </div>
